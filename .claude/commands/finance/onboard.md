...
5. Company basics: entity name, entity type (LLC, C-Corp, S-Corp, sole prop, partnership), state/country of incorporation, fiscal year end, primary currency
...
9. Chart of accounts configuration:
...
10. Bank and payment connections:
...
11. Revenue streams and pricing:
...
12. Major expenses and recurring costs:
...
14. Cash flow baseline:
    - Current cash position
    - Monthly cash burn
    - Runway calculation (cash / monthly burn)
    - Expected inflows: revenue, funding, grants

15. Create workspace from _template/, fill in all gathered information
16. Display summary:
